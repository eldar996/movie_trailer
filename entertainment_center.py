...
coco = media.Movie("Coco",
                   ...
                   "https://vignette.wikia.nocookie.net/disney/images/1/14/Coco_poster.png/revision/latest?cb=20170912170727",  # NOQA
...
wall_e = media.Movie("WALL-E",
                     ...
                     "https://pixar-planet.fr/wp-content/uploads/2010/04/affiche-walle-40.jpg",  # NOQA
...
big_hero6 = media.Movie("Big Hero 6",
                        ...
                        "of high-tech heroes.",
                        "https://images-na.ssl-images-amazon.com/images/I/81%2BMTze25KL._SL1500_.jpg",  # NOQA
...
dragon = media.Movie("How to Train Your Dragon",
                   ...
                   "http://cdn.collider.com/wp-content/uploads/how-to-train-your-dragon-2-poster2.jpg",  # NOQA
...
ferdinand = media.Movie("Ferdinand",
                   ...
                   "rm,",
                   "https://i.pinimg.com/originals/74/54/57/745457295a72883a4d3fc516adbc03e2.jpg",  # NOQA
...
brave = media.Movie("Brave",
                   ...
                   " with the present",
                   "https://lumiere-a.akamaihd.net/v1/images/open-uri20150422-7119-1mm8kcq_30f3d3a4.jpeg?region=0,0,1000,1409",  # NOQA
...
monsters = media.Movie("Monsters",
                   ...
                   "https://vignette.wikia.nocookie.net/disney/images/f/fe/1000px-Monsters_inc_ver1_xlg.jpeg/revision/latest?cb=20160202161958",  # NOQA
...
inside_out = media.Movie("Inside Out",
                   ...
                   "https://vignette.wikia.nocookie.net/disney/images/f/fb/Inside-Out-60.png/revision/latest?cb=20150304211113",  # NOQA
                   "https://www.youtube.com/watch?v=QxrQ6BaijAY")
